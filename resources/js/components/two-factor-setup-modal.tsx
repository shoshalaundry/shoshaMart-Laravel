    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'Otentikasi dua faktor sekarang aktif. Pindai kode QR atau masukkan kunci pengaturan di aplikasi autentikator Anda.',
                buttonText: 'Tutup',
            };
        }
        ...
        return {
            ...
            description:
                'Untuk menyelesaikan pengaktifan otentikasi dua faktor, pindai kode QR atau masukkan kunci pengaturan di aplikasi autentikator Anda',
            buttonText: 'Lanjutkan',
        };
