                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Anda akan diminta memasukkan PIN yang aman dan acak
                                saat masuk, yang dapat Anda ambil dari aplikasi
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                ...
                                akan diminta memasukkan PIN yang aman saat masuk.
                                PIN ini dapat diambil dari aplikasi pendukung
                                TOTP di ponsel Anda.
                            </p>
